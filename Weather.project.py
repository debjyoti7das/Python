...
def data_get():
    city=city_name.get()
    data= requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=0731a137c727e7e0b33fdb9c39ec1663").json()
...
done_button = Button(win, text="Enter", font=("Times New Roman", 20, "bold"),command=data_get)
